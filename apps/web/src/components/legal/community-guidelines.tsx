    ...
    <>
      ...
      <LegalSection title="2. Do not discriminate">
        <p>
          ...
          communities, and we respect them all.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Do not engage in harmful activity">
        <p>
          myHoodora prohibits activity that could harm others — whether
          it&apos;s physical harm, scams, fraud, or sharing someone&apos;s personal
          information or exact address without their consent.
        </p>
      </LegalSection>
