...
type AlertCategory = "Crime" | "Suspicious Activity" | "Lost Pet" | "Community Notice";
      ...
      <div className="flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex items-center gap-3">
          <div className="flex -space-x-2">
            {["bg-primary/20", "bg-amber-200", "bg-rose-200", "bg-sky-200"].map(
              (color, i) => (
                <div
                  key={i}
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <Badge className={CATEGORY_STYLES[alert.category]}>
                {alert.category === "Crime" || alert.category === "Suspicious Activity" ? (
            ...
            <div>
              <h3 className="text-sm font-black text-slate-800">{alert.title}</h3>
